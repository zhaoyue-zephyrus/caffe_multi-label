...
bool ReadFileToDatum(const string& filename, const std::vector<int> label, Datum* datum);
...
inline bool ReadImageToDatum(const string& filename, const std::vector<int> label,
